...
public static class Extensions
{
    ...
    public static Transform TweenScale(this Transform target, float scaleFactor = 1f, float tweenDuration = 0.5f)
    {
    ...
    {
        // target.DOScale(scaleFactor, tweenDuration);
        target.DOPunchScale(Vector3.one * scaleFactor, tweenDuration);
        return target;
    }
